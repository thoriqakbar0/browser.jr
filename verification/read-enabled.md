...
| ENABLED-05 | P1 | pipe | Direct selectors read native enabled state without a snapshot ([Finish](../inspection/read-enabled.md#finish)). | Serve a disabled native button. | Read enabled state through CSS. | The result is false. | partial: package, compiled-process, and controlled agent-browser comparison passed, 2026-08-31 |
