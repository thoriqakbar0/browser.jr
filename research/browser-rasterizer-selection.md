...
Implementation update, 31 August 2026: browser.jr now builds solid background and border fill commands for viewport, full-page, locator, and rectangle captures. A bounded in-process software rasterizer provides correctness fixtures and PNG output. It blocks every unsupported visible paint case it detects. The selected complete-renderer direction remains a separate helper.
